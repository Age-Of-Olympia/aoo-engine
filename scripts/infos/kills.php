    ...
    if(!count($assists)){
        ...
        foreach($assists as $row){
            ...
            <tr>
                ...
                echo '<td><a href="infos.php?targetId='. $target->id .'">'. $target->data->name .'</a> (rang '. $row->player_rank .') a contribué à la mort de <a href="infos.php?targetId='. $killed->id .'">'. $killed->data->name .'</a> (rang '. $row->target_rank .')</td>';
    ...
    if(!count($deaths)){
        ...
        foreach($deaths as $row){
            ...
            <tr>
                ...
                echo '<td><a href="infos.php?targetId='. $assistant->id .'">'. $assistant->data->name .'</a> (rang '. $row->player_rank .') a tué <a href="infos.php?targetId='. $killed->id .'">'. $killed->data->name .'</a> (rang '. $row->target_rank .')</td>';
