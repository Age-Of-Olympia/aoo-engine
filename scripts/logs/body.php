...
/*
 * Corps de la page des évènements, partagé entre la page complète
 * (logs.php, enveloppe Ui) et le panneau glissant du HUD
 * (load_logs.php). Les onglets restent des liens logs.php : le
 * routeur de panneaux (js/hud.js) les réécrit en fragments.
 */
