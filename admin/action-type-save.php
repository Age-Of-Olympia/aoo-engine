...
try {
    ...
    (new ActionTypeInstructionEditService())->saveParameters(
        $typeKey,
        is_array($_POST['type_inst'] ?? null) ? $_POST['type_inst'] : [],
        is_array($_POST['type_inst_raw'] ?? null) ? $_POST['type_inst_raw'] : [],
    );
    setFlash('success', 'Défauts du type enregistrés.');
