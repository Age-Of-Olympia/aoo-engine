...
function dialogs_render_form(?array $dialog, string $csrfToken): string
{
    ...
    return '<div class="d-flex justify-content-between align-items-center mb-3">'
        ...
        . ' comptoir : la carte de la case affiche un bouton par onglet servi. Pour choisir son apparence,'
        . ' ajoutez <code style="display:inline">icon</code> (classe'
        . ' <a href="https://nagoshiashumari.github.io/Rpg-Awesome/" target="_blank">rpg-awesome</a>, ex.'
        . ' <code style="display:inline">ra-anvil</code>) et <code style="display:inline">button</code>'
        . ' (libellé) à l\'option. Sans ces clés : Banque, Réparer, Recycler pour ces onglets,'
        . ' sinon Marchander ou Apprendre.</small>'
        . '</div></div>'
