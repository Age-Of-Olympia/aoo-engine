...
HTML;
    ...
    return '<div class="d-flex justify-content-between align-items-center mb-3">'
        ...
        . ' <strong>pas encore implémentées</strong> : aucune mécanique de jeu ne les lit — les cocher n\'a aucun'
        . ' effet pour les joueurs aujourd\'hui. Elles préparent une future gestion des factions en jeu.'
        . ' Exception : « Défaut » sert déjà à la page Membres (rôle de repli quand un index est invalide).'
        . '</div>'
        . '</div></div>'
