...
/**
 * Opt-in companion to {@see XpCalculator} for the rare XP rule that, beyond
 ...
 *
 * Keeping it off the XpCalculator interface lets calculate() stay a pure
