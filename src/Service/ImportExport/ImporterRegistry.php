...
final class ImporterRegistry
{
    ...
    {
        foreach ($importers ?? [new ActionImporter(), new PassiveImporter(), new ActionTypeConfigImporter(), new RaceImporter(), new FactionImporter(), new PlanImporter(), new DialogImporter()] as $importer) {
