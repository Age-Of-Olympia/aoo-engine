...
final class EffectExporter implements ObjectExporterInterface
{
    ...
    public function toArray(object $entity): array
    {
        ...
        return [
            ...
            'dodgeScope'            => $entity->getDodgeScope(),
            'dodgeAttackerWeapon'   => $entity->getDodgeAttackerWeapon(),
            'dodgeDefenderWeapon'   => $entity->getDodgeDefenderWeapon(),
            'dodgeReaction'         => $entity->getDodgeReaction(),
            'dodgeMessage'          => $entity->getDodgeMessage(),
            'grantsFlight'          => $entity->grantsFlight(),
            'costMultiplier'        => $entity->isCostMultiplier(),
            'blocksTrading'         => $entity->blocksTrading(),
            'stackRefreshDuration'  => $entity->isStackRefreshDuration(),
