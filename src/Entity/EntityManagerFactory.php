...
final class EntityManagerFactory
{
    ...
    public static function getEntityManager(?Connection $connection = null): EntityManager
    {
        if (self::$em === null) {
            ...
            $connection = $connection ?? DriverManager::getConnection(DB_CONSTANTS, $orm_db_config);
