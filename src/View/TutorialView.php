...
?>
        ...
        <!-- Tutorial CSS -->
        <link href="css/tutorial/tutorial.css?v=20251122r" rel="stylesheet">

        <!-- Tutorial JavaScript - NEW MODULAR SYSTEM -->
        <script src="js/tutorial/TutorialPositionManager.js?v=20251118a"></script>
        <script src="js/tutorial/TutorialUI.js?v=20251122p"></script>
        <script src="js/tutorial/TutorialHighlighter.js?v=20251122c"></script>
        <script src="js/tutorial/TutorialTooltip.js?v=20251122r"></script>
