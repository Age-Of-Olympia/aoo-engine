...
?>
        ...
        <!-- Tutorial CSS -->
        <link href="css/tutorial/tutorial.css?v=20251114d" rel="stylesheet">

        <!-- Tutorial JavaScript - NEW MODULAR SYSTEM -->
        <script src="js/tutorial/TutorialUI.js?v=20251114p"></script>
        <script src="js/tutorial/TutorialHighlighter.js?v=20251114a"></script>
        <script src="js/tutorial/TutorialTooltip.js?v=20251114e"></script>
        <script src="js/tutorial/TutorialInit.js?v=20251114b"></script>
<?php
    }
}
