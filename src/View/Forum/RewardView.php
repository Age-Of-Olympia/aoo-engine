...
class RewardView
{
    public static function renderRewards(): void
    {
...
?>
                <div id="data">
                    <script>
                        alert('Vous ne pouvez pas récompenser une Missive.');
                    </script>
                </div>
            <?php
            ...
            ?>
                <div id="data">
                    <script>
                        alert('Vous ne pouvez pas récompenser vos propres posts.');
                    </script>
                </div>
            <?php
    ...
    ';
            ...
            ?>
                <div id="data">
                    <script>
                        alert('Vous ne possédez aucune récompense à donner.');
                    </script>
                </div>
            <?php
