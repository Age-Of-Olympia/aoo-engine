...
final class SkillTreeView
{
    ...
    public static function styles(): string
    {
        return '<style>'
            ...
            . '.ws-content .ws-legend{margin-bottom:20px;background:rgba(0,0,0,.05);padding:10px;border-radius:5px}'
            . '.ws-content .ws-legend summary{cursor:pointer;display:flex;align-items:center;justify-content:center;font-weight:bold;margin:15px 0;outline:none}'
