...
final class AccountView
{
    ...
    public static function buildOptions(Player $player): array
    {
        $options = array(
            ...
            'hideLineOfFire' => "Masquer la ligne de tir sur le plateau<br /><sup>La trajectoire (vert : dégagée, rouge : bloquée) ne se dessinera plus sur le damier — l'information reste dans le panneau de case</sup>",
