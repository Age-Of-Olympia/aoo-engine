...
final class Version20250322163719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action_effects (id INT AUTO_INCREMENT NOT NULL, apply_to_self TINYINT(1) DEFAULT 0 NOT NULL, name VARCHAR(100) DEFAULT NULL, on_success tinyint(1) NOT NULL DEFAULT 1, action_id INT NOT NULL, INDEX IDX_92A9B44B9D32F035 (action_id), PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE actions (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) NOT NULL, name VARCHAR(50) NULL, display_name VARCHAR(50) NULL, text LONGTEXT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE effect_instructions (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) NOT NULL, parameters JSON DEFAULT NULL, orderIndex INT DEFAULT 0 NOT NULL, effect_id INT NOT NULL, INDEX IDX_9DA2AC6FF5E9B83B (effect_id), PRIMARY KEY(id))');
