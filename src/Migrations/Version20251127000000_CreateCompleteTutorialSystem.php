...
final class Version20251127000000_CreateCompleteTutorialSystem extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Perimeter walls: single-statement ring seed with NOT EXISTS
        // dedup. map_walls has no unique index on (coords_id, name),
        // so four separate INSERT IGNOREs (one per cardinal) double-
        // insert at the four corners — 36 walls instead of 32.
        $this->addSql("
