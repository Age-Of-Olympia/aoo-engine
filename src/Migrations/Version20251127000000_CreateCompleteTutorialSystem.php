...
final class Version20251127000000_CreateCompleteTutorialSystem extends AbstractMigration
{
    ...
    private function insertTutorialUI(): void
    {
        ...
        $this->addSql("
            INSERT INTO tutorial_step_ui (step_id, target_selector, tooltip_position, interaction_mode, show_delay, allow_manual_advance, auto_close_card, tooltip_offset_x, tooltip_offset_y, caracs_panel_state)
            SELECT id, NULL, 'center', 'blocking', 0, 1, 0, 0, 0, 'closed' FROM tutorial_steps WHERE step_id = 'welcome' UNION ALL
            SELECT id, '.case[data-coords=\"0,0\"]', 'bottom', 'blocking', 200, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'your_character' UNION ALL
            SELECT id, '.case[data-coords=\"1,0\"]', 'right', 'semi-blocking', 0, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'meet_gaia' UNION ALL
            SELECT id, '#ui-card .close-card', 'right', 'semi-blocking', 300, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'close_card' UNION ALL
            SELECT id, '.case.go', 'top', 'blocking', 300, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'movement_intro' UNION ALL
            SELECT id, '.case.go', 'top', 'semi-blocking', 0, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'first_move' UNION ALL
            SELECT id, NULL, 'center', 'blocking', 0, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'movement_limit_warning' UNION ALL
            SELECT id, '#show-caracs', 'bottom', 'semi-blocking', 700, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'show_characteristics' UNION ALL
            SELECT id, '#mvt-counter', 'right', 'semi-blocking', 700, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'deplete_movements' UNION ALL
            SELECT id, '#mvt-counter', 'right', 'blocking', 700, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'movements_depleted_info' UNION ALL
            SELECT id, '#action-counter', 'right', 'blocking', 700, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'actions_intro' UNION ALL
            SELECT id, '#current-player-avatar', 'bottom', 'semi-blocking', 0, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'click_yourself' UNION ALL
            SELECT id, '.card-actions', 'right', 'blocking', 300, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'actions_panel_info' UNION ALL
            SELECT id, '#ui-card .close-card', 'right', 'semi-blocking', 0, 1, 1, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'close_card_for_tree' UNION ALL
            SELECT id, '.case[data-coords=\"0,1\"]', 'center-bottom', 'semi-blocking', 0, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'walk_to_tree' UNION ALL
            SELECT id, '.case[data-coords=\"0,1\"]', 'bottom', 'semi-blocking', 0, 0, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'observe_tree' UNION ALL
            SELECT id, '.resource-status', 'left', 'blocking', 300, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'tree_info' UNION ALL
            SELECT id, '.action[data-action=\"fouiller\"]', 'right', 'semi-blocking', 300, 1, 1, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'use_fouiller' UNION ALL
            SELECT id, '#action-counter', 'right', 'blocking', 700, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'action_consumed' UNION ALL
            SELECT id, '#show-inventory', 'bottom', 'semi-blocking', 300, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'open_inventory' UNION ALL
            SELECT id, '.item-case[data-name=\"Bois\"]', 'left', 'blocking', 700, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'inventory_wood' UNION ALL
            SELECT id, '#back', 'bottom', 'semi-blocking', 200, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'close_inventory' UNION ALL
            SELECT id, NULL, 'center', 'blocking', 0, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'combat_intro' UNION ALL
            SELECT id, '.tutorial-enemy', 'bottom', 'blocking', 500, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'enemy_spawned' UNION ALL
            SELECT id, '.tutorial-enemy', 'center-bottom', 'semi-blocking', 0, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'walk_to_enemy' UNION ALL
            SELECT id, '.tutorial-enemy', 'bottom', 'semi-blocking', 0, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'click_enemy' UNION ALL
            SELECT id, '.action[data-action=\"attaquer\"]', 'right', 'semi-blocking', 0, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'attack_enemy' UNION ALL
            SELECT id, '#red-filter', 'right', 'blocking', 700, 1, 0, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'attack_result' UNION ALL
            SELECT id, NULL, 'center', 'blocking', 0, 1, NULL, 0, 0, NULL FROM tutorial_steps WHERE step_id = 'tutorial_complete'
        ");
    }
