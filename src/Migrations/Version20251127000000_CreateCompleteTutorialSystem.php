...
final class Version20251127000000_CreateCompleteTutorialSystem extends AbstractMigration
{
    ...
    private function insertTutorialSteps(): void
    {
        ...
        $this->addSql("
            ...
            ('1.0.0', 'movement_intro', 'first_move', 5.0, 'info', 'Se déplacer', 'Regardez les <strong>cases</strong> autour de vous : ce sont les cases où vous pouvez vous déplacer. Les cases marquées d''un <strong>⛔</strong> sont infranchissables (murs, joueurs, cases interdites). En jeu, ce repère peut être activé dans vos options.', 5, 1),
            ...
            ('1.0.0', 'actions_intro', 'click_yourself', 11.0, 'info', 'Les Actions', 'En plus des mouvements, vous avez des <strong>Actions (A)</strong>. Elles permettent de fouiller, attaquer, récolter...', 5, 1),
            ...
            ('1.0.0', 'actions_panel_info', 'close_card_for_tree', 13.0, 'info', 'Panneau d''actions', 'Voici vos <strong>actions disponibles</strong> ! Chaque action consomme une ou plusieurs A. Nous allons en tester une : la récolte de ressources.', 5, 1),
            ...
            ('1.0.0', 'action_consumed', 'open_inventory', 20.0, 'info', 'Action consommée', 'Vous avez récolté du <strong>bois</strong> ! Remarquez que l''action a consommé <strong>1 A</strong>. Vos A se régénèrent aussi à chaque tour.', 5, 1),
