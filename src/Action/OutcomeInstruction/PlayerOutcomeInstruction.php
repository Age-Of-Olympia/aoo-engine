...
#[ORM\Entity]
class PlayerOutcomeInstruction extends OutcomeInstruction implements HasParameterSchemaInterface
{
    ...
    public function execute(Player $actor, Player $target, ConditionObject $conditionObject): OutcomeResult {
        ...
        // e.g. {"carac": "energie", "value": 4}; the outcome's toggle says who.
        $onActor = $this->receiver($actor, $target) === $actor;
